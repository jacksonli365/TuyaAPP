...
public class LampPresenter extends BasePresenter implements ILightListener {
    ...
    public void popscene1() {
        HashMap<String, Object> dpCodeMap = new HashMap<>();
        dpCodeMap.put("flash_scene_1", "ffff100111f633");
    ...
    public void popscene2() {
        HashMap<String, Object> dpCodeMap = new HashMap<>();
        dpCodeMap.put("flash_scene_2", "ffff1006ff0088001100660036980000");
        mLightDevice.publishCommands(dpCodeMap, new IResultCallback(){
                @Override
                public void onError(String code, String error) {
    ...
    public void popscene3(){
        HashMap<String, Object> dpCodeMap = new HashMap<>();
        dpCodeMap.put("flash_scene_3","fff0601113355");
        mLightDevice.publishCommands(dpCodeMap, new IResultCallback(){
            @Override
            public void onError(String code, String error) {
            }
    ...
    public void popscene4(){
        HashMap<String, Object> dpCodeMap = new HashMap<>();
        dpCodeMap.put("flash_scene_4", "ffff0205ff000000ff00ffff00ff00ff0000ff");
        mLightDevice.publishCommands(dpCodeMap, new IResultCallback(){
            @Override
            public void onError(String code, String error) {
            }
