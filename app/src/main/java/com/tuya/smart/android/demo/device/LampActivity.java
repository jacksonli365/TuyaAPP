...
public class LampActivity extends BaseActivity implements ILampView {
    ...
    @BindView(R.id.ll_lamp_bottom_operation)
    ...
    @BindView(R.id.activity_lamp)
    public View mActivity_lamp;
    ...
    public void showLampView() {
        ...
        mActivity_lamp.setBackgroundResource(R.drawable.lamop);
    }
    ...
    public void hideLampView() {
        ...
        mActivity_lamp.setBackgroundResource(R.drawable.bg_lamp);
    }
    ...
    public void scene1() {
        ...
        mLampModeViewTip.setText("@string/scene6");
    }

    @OnClick(R.id.scene2)
    public void scene2() {
        View view = getLayoutInflater().inflate(R.layout.lamp_pop,null);
        TextView textView1 = (TextView) view.findViewById(R.id.pop_scane1);
        TextView textView2 = (TextView) view.findViewById(R.id.pop_scane2);
        TextView textView3 = (TextView) view.findViewById(R.id.pop_scane3);
        TextView textView4 = (TextView) view.findViewById(R.id.pop_scane4);
        textView1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {

                mLampPresenter.popscene1();
                mLampModeViewTip.setText("柔光情景");
                mpop.dismiss();
            }
        });
        textView2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                mLampPresenter.popscene2();
                mLampModeViewTip.setText("缤纷情景");
                mpop.dismiss();
            }
        });
        textView3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                mLampPresenter.popscene3();
                mLampModeViewTip.setText("炫彩情景");
                mpop.dismiss();
            }
        });
        textView4.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                mLampPresenter.popscene4();
                mLampModeViewTip.setText("斑斓情景");
                mpop.dismiss();
            }
        });
        mpop = new PopupWindow(view,mLampSwitchButton2.getWidth(), ViewGroup.LayoutParams.WRAP_CONTENT);
        mpop.setTouchable(true);
        mpop.setOutsideTouchable(true);
        mpop.setFocusable(true);
        mpop.showAsDropDown(mLampSwitchButton2);
    ...
    public void onDestroy() {
        super.onDestroy();
        mLampPresenter.onDestroy();        mLampSwitchButton1.setVisibility(View.GONE);
